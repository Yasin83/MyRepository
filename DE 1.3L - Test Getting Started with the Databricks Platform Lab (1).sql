...
-- MAGIC %md ###This is my Header
-- MAGIC 
-- MAGIC This is a simple Text
-- MAGIC * line1
-- MAGIC * line2
-- MAGIC * line3
-- MAGIC 
...
-- MAGIC 
-- MAGIC This is text with a *italicized* word in it.
-- MAGIC 
-- MAGIC Links/Embedded HTML: <a href="https://en.wikipedia.org/wiki/Markdown" target="_blank">Markdown - Wikipedia</a>
-- MAGIC 
-- MAGIC Links/Embedded HTML: <a href="https://en.wikipedia.org/wiki/Mannheim">Mannheim - Wikipedia</a>
-- MAGIC 
-- MAGIC Images:
-- MAGIC ![Spark Engines](https://files.training.databricks.com/images/Apache-Spark-Logo_TM_200px.png)
-- MAGIC 
-- MAGIC Images:
-- MAGIC ![Spark Engines](https://files.training.databricks.com/images/105/labs.png)
-- MAGIC 
